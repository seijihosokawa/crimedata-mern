...
function ApiCard({endpoint}) {
    ...
    if(ApiCardSelect === "python"){
        ...
        request = <div id="codeBlock"><span className="text-yellow-100">curl</span> https://crimedata-mern.herokuapp.com{endpoint}</div>
    }
        ...
        <div className="text-sm">
            <code>                                
                <p className="pl-4 pt-1 pb-1 rounded-t bg-gray-700 text-gray-400" ><span className="text-blue-600">GET</span> {endpoint}                 
                    ...
                    <select className="float-right mr-2 bg-gray-700" onChange={handleChange}> 
